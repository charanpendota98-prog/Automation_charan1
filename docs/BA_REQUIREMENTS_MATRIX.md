# BA REQUIREMENTS MATRIX — studentup.in (v42 → v70)
...
python run.py --pin-check         # per-post certificate (68 checks) sample
...
|---|---|---|---|
| Post quality gates | 100/100 · 0 critical | **100/100 · 68/68 · critical 0** | `python run.py --pin-check` |
