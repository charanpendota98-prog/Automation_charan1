...
Checks (offline only):
  ...
  * docs: README v81 + MANUAL PART 40 + 68/68
...
def test_docs_v81():
    ...
    assert suites == 94, f"suites {suites} (v114 tho 94 expect)"
    ...
    print("  docs: README v81 + MANUAL PART 40 + 68/68 ✔")
...
TESTS = [
    ...
    ("docs: v81 + PART 40 + 68/68", test_docs_v81),
]
