...
def test_docs_v75():
    ...
    assert suites == 57, f"suites {suites} (v75 tho 57 expect)"
    readme = read(ROOT / "README.md")
    manual = read(ROOT / "MANUAL_ADVANCED_CHECKLIST.md")
    go_live = read(ROOT / "GO_LIVE_CHECKLIST.md")
    assert "### v75" in readme and "57/57" in readme
    assert "PART 34" in manual and "v75" in manual and "57/57" in manual
    assert "57/57" in go_live
...
TESTS = [
    ...
    ("docs: README v75 + MANUAL PART 34 + 57/57", test_docs_v75),
]
