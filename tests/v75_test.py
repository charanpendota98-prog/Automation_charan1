...
def test_docs_v75():
    ...
    assert "### v75" in readme and "62/62" in readme
    assert "PART 34" in manual and "v75" in manual and "62/62" in manual
...
TESTS = [
    ...
    ("docs: README v75 + MANUAL PART 34 + 62/62", test_docs_v75),
]
