...
def test_docs_v75():
    ...
    assert "### v75" in readme and "68/68" in readme
    assert "PART 34" in manual and "v75" in manual and "68/68" in manual
...
TESTS = [
    ...
    ("docs: README v75 + MANUAL PART 34 + 68/68", test_docs_v75),
]
