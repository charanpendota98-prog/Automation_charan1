...
from autoblog import ad_manager, config, wp_theme_sync  # noqa: E402
...
def test_docs_v75():
    ...
    assert "### v75" in readme and "61/61" in readme
    assert "PART 34" in manual and "v75" in manual and "61/61" in manual
...
TESTS = [
    ...
    ("docs: README v75 + MANUAL PART 34 + 61/61", test_docs_v75),
]
