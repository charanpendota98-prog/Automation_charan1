...
def test_docs_v76():
    ...
    assert "### v76" in readme and "62/62" in readme
    assert "PART 35" in manual and "v76" in manual and "62/62" in manual
...
TESTS = [
    ...
    ("docs: README v76 + MANUAL PART 35 + 62/62", test_docs_v76),
]
