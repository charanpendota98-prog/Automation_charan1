...
def test_docs_v76():
    ...
    assert "### v76" in readme and "61/61" in readme
    assert "PART 35" in manual and "v76" in manual and "61/61" in manual
...
TESTS = [
    ...
    ("docs: README v76 + MANUAL PART 35 + 61/61", test_docs_v76),
]
