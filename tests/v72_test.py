...
def test_theme_version_parity_v72():
    ...
    assert css == php == stable == "1.9.0", f"version parity tappu: {css} · {php} · {stable}"
    assert "= 1.9.0" in read(THEME / "readme.txt")
...
TESTS = [
    ...
    ("theme version parity 1.9.0", test_theme_version_parity_v72),
    ...
    ("v89: theme version 1.9.0 parity", test_theme_version_1721),
]
