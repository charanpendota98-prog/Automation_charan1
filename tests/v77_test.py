...
Checks (offline only):
  ...
  * docs: README v77 + MANUAL PART 36 + 67/67 + networks kit
...
def test_docs_v77():
    ...
    assert suites == 67, f"suites {suites} (v86 tho 67 expect)"
    readme = read(ROOT / "README.md")
    manual = read(ROOT / "MANUAL_ADVANCED_CHECKLIST.md")
    go_live = read(ROOT / "GO_LIVE_CHECKLIST.md")
    assert "### v77" in readme and "67/67" in readme
    assert "PART 36" in manual and "v77" in manual and "67/67" in manual
    ...
    print("  docs: README v77 + MANUAL PART 36 + 67/67 + kit ✔")
...
TESTS = [
    ...
    ("docs: v77 + PART 36 + 67/67 + kit", test_docs_v77),
]
