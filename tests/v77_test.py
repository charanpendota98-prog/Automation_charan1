...
Checks (offline only):
  ...
  * docs: README v77 + MANUAL PART 36 + 59/59 + networks kit
...
def test_docs_v77():
    ...
    assert "### v77" in readme and "59/59" in readme
    assert "PART 36" in manual and "v77" in manual and "59/59" in manual
    ...
    print("  docs: README v77 + MANUAL PART 36 + 59/59 + kit ✔")
...
TESTS = [
    ...
    ("docs: v77 + PART 36 + 59/59 + kit", test_docs_v77),
]
