...
Checks (offline only):
  ...
  * docs: README v77 + MANUAL PART 36 + 66/66 + networks kit
...
def test_docs_v77():
    ...
    assert "### v77" in readme and "66/66" in readme
    assert "PART 36" in manual and "v77" in manual and "66/66" in manual
    ...
    print("  docs: README v77 + MANUAL PART 36 + 66/66 + kit ✔")
...
TESTS = [
    ...
    ("docs: v77 + PART 36 + 66/66 + kit", test_docs_v77),
]
